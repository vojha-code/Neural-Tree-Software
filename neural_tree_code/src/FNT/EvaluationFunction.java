...
public class EvaluationFunction {
     ...
     */
    public double evaluateFitness(FNT tree, int m_OutputColumn) { //MSE
    ...
    public double evaluateFitness(FNT tree, String fileName) { //MSE
        double predicted = 0.0, error = 0.0, errorSum = 0.0;
        try {
     ...
     * @return training fitness over training data
     */
    public double[] testTrain(FNT tree) {
        double predicted = 0.0, error = 0.0, errorSum = 0.0;
     ...
     * @return training fitness over training data
     */
    public double[][] test(FNT[][] tree, int m_Ensemble_CandidatesInt, PrintWriter file) {
     ...
     * @return training fitness over training data
     */
    public double[][] testTrain(FNT[][] tree, int m_Ensemble_CandidatesInt, PrintWriter file) {
        double[][] errorSum = new double[m_OutputsCount][m_Ensemble_CandidatesInt];
        int[][] errorRate = new int[m_OutputsCount][m_Ensemble_CandidatesInt];
        for (int j = 0; j < m_OutputsCount; j++) {
            for (int k = 0; k < m_Ensemble_CandidatesInt; k++) {

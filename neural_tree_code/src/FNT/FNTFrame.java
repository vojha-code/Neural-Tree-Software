 ...
 */
public class FNTFrame extends javax.swing.JFrame {
    ...
    class DataWorker extends SwingWorker<Integer, Integer> {
        ...
        public DataWorker(FNTFrame frameFNT) {
        ...
        protected Integer doInBackground() throws Exception {
            ...
            if (!isaNormData) {//if false or if not a normalized data
            ...
            fntDataFileInfo.add(4, isClassification);// problem is classification boolean
            ...
            fntDataFileInfo.add(12, isaNormData);// is it a normalized dataset boolean
            ...
            jTextField_Display_Massage.setText("Dataset Loaded: GO TO TAB FNT Modelling");
    ...
    class AnswerWorkerFNTtraining extends SwingWorker<Integer, Integer> {
        ...
        //variable for FNT training modeuls
        FNTFrame frameFNT;
        ...
        public AnswerWorkerFNTtraining(FNTFrame frameFNT) {
            this.frameFNT = frameFNT;
        }
        ...
        protected Integer doInBackground() throws Exception {
            ...
            if (!setPatameters()) {//setParameters
                return null;
            } else {
            ...
            if (selected_training_model.equalsIgnoreCase("new")) {
                System.out.println("Trainnig models :" + trainFNTmodels());
            } else {//if old models
                bestGlobalTree = null;
        ...
        private boolean trainFNTmodels() {
            ...
            for (int j = 0; j < Ot; j++) {//FNT training parameters
                ...
                GP gp = new GP(fntRNG, ev, treeParameters, gpParameters, mhParameters, algoParameters, ensembleParameters);
                //Recieved trainined model(s)
                FNT[] bestGlobalTreeLocal = gp.doEvolution(inputsCount, j);//tainng for jth target
        ...
        private double[][] crossValidation() {
            CrossValidationFNT crossValidation = new CrossValidationFNT();
        ...
        private boolean setPatameters() {
            ...
            try {
                ...
                double mhMIN_Node = Double.parseDouble(jTextBox_mhMIN_Node.getText());
                double mhMAX_Node = Double.parseDouble(jTextBox_mhMAX_Node.getText());
                double mhMIN_Edge = Double.parseDouble(jTextBox_mhMIN_Edge.getText());
                double mhMAX_Edge = Double.parseDouble(jTextBox_mhMAX_Edge.getText());
                boolean weightsOnly = jComboBox_WeightsOnly.getSelectedItem().toString().equals("Edges_only");
                ...
                if (!m_Ensemble_Candidates.equals("1")) {
                    ...
                    bestGlobalTree = new FNT[Ot][ensembleCandidates];
                } else {
                ...
                treeParameters.add(4, mhMIN_Node);//double mh min node 
                treeParameters.add(5, mhMAX_Node);//double mh max naode
                treeParameters.add(6, mhMIN_Edge);//double mh min edge
                treeParameters.add(7, mhMAX_Edge);//double mh max edge
                treeParameters.add(8, weightsOnly);//boolean parameter optimization type
                ...
                gpParameters.add(0, gpPOP);//int GP population
                gpParameters.add(1, gpELITISM);//double GP Elitism
                gpParameters.add(2, gpMUTATION_PROB);//double GP Mutation
                gpParameters.add(3, gpCROSSOVER_PROB);//double GP Crossover
                gpParameters.add(4, gpTOURNAMENT_SIZE);//double GP Tournament
                gpParameters.add(5, gpITR);//int GP iteration
                gpParameters.add(6, selectTrainingMode);//int GP Training Mode
        ...
        private void storeParameters(ArrayList treeParameters, ArrayList ensembleParameters, ArrayList gpParameters, ArrayList mhParameters, ArrayList algoParameters, ArrayList ensembleAlgoParameters, ArrayList cvParameter) {
            ...
            fntTrainParam = ""
                    ...
                    + "#,Tree_Node_Type:," + treeParameters.get(3) + "\n"// int  activation function type
                    + "#,Tree_Node_Range:," + treeParameters.get(4) + "," + treeParameters.get(5) + "\n"//double mh min node //double mh max naode
                    + "#,Tree_Edge_Range:," + treeParameters.get(6) + "," + treeParameters.get(7) + "\n"//double mh min edge //double mh max edge
                    + "#,Optimize_Tree_parameters:," + treeParameters.get(8) + "\n"//boolean parameter optimization type
    ...
    private void initComponents() {
        ...
        jTextBox_mhMIN_Node = new javax.swing.JTextField();
        jLabel19 = new javax.swing.JLabel();
        jLabel20 = new javax.swing.JLabel();
        jTextBox_mhMAX_Node = new javax.swing.JTextField();
        jLabel22 = new javax.swing.JLabel();
        jLabel23 = new javax.swing.JLabel();
        jTextField_GP_MR = new javax.swing.JTextField();
        jTextField_GP_CR = new javax.swing.JTextField();
        jTextBox_mhMAX_Edge = new javax.swing.JTextField();
        jLabel25 = new javax.swing.JLabel();
        jTextBox_mhMIN_Edge = new javax.swing.JTextField();
        ...
        jTextArea_DataDisplay.setBorder(null);
        jScrollPane10.setViewportView(jTextArea_DataDisplay);
        ...
        fileBrowsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(fileBrowsPanelLayout.createSequentialGroup()
                .addGroup(fileBrowsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(fileBrowsPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jTextField_Display_Massage))
                    .addGroup(fileBrowsPanelLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(showdata_, javax.swing.GroupLayout.DEFAULT_SIZE, 538, Short.MAX_VALUE))
                .addGap(31, 31, 31))
        );
        ...
        dataSelectLayout.setHorizontalGroup(
            ...
            .addGroup(dataSelectLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(fileBrowsPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        dataSelectLayout.setVerticalGroup(
            dataSelectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(dataSelectLayout.createSequentialGroup()
                .addGroup(dataSelectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jRadioButton_GP_MO, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(trainFNTModel_STOP, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)))
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jTextBox_SEED_INPUT, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
        ...
        jComboBox_WeightsOnly.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Eadge_and_Nodes", "Edges_only" }));
        ...
        jLabel12.setText("Meta-heuristic Algorithm  ");
        ...
        jLabel16.setText("Function Node Type");

        jComboBox_FunType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Random_Selection", "Gaussian", "Tangent_hyperbolic", "Fermi", "Linear_Fermi", "Linear_Tangent_hyperbolic", "Unipolar_Sigmoid", "Bipolar_Sigmoid" }));

        jLabel18.setText("Node Search Space:");

        jTextBox_mhMIN_Node.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jTextBox_mhMIN_Node.setText("0.0");
        jTextBox_mhMIN_Node.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextBox_mhMIN_NodeFocusLost(evt);
            }
        });
        ...
        jTextBox_mhMAX_Node.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jTextBox_mhMAX_Node.setText("1.0");
        jTextBox_mhMAX_Node.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextBox_mhMAX_NodeFocusLost(evt);
            }
        });
        ...
        jTextBox_mhMAX_Edge.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jTextBox_mhMAX_Edge.setText("1.0");
        jTextBox_mhMAX_Edge.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextBox_mhMAX_EdgeFocusLost(evt);
            }
        });

        jLabel25.setText("Max");

        jTextBox_mhMIN_Edge.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jTextBox_mhMIN_Edge.setText("-1.0");
        jTextBox_mhMIN_Edge.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextBox_mhMIN_EdgeFocusLost(evt);
            }
        });

        jLabel26.setText("Min");

        jLabel27.setText("Edge Search Space:");
        ...
        jLabel6.setText("Max Metaheuristic Iteration");
        ...
        setParamFromFile_.setText("Browse a Setup");
        ...
        jLabel14.setText("Number of Modes");
        ...
        jLabel35.setText("Number of Folds");
        ...
        jPanel_ParameterLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ParameterLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(setParamFromFile_, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel_ParameterLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboBox_FunType, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ParameterLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextBox_mhMIN_Node, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel20, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextBox_mhMAX_Node, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jComboBox_WeightsOnly, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jComboBox_Ensemble_Candidates, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jComboBox_MH_Algo, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ParameterLayout.createSequentialGroup()
                        .addComponent(jLabel26, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jTextBox_mhMIN_Edge, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel25, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextBox_mhMAX_Edge, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jComboBox_Ensemble_Method, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jComboBox_Manual_TRN_Size, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(jComboBox_FoldType, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(10, 10, 10))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ParameterLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextBox_GP_TS, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextBox_MH_POP, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                        .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel_EN_1)
                            .addComponent(jLabel_EN_2)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ParameterLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                        .addComponent(jLabel_EN_7, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jTextBox_enWTmin, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(21, 21, 21)
                        .addComponent(jLabel_EN_8, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextBox_enWTmax, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jComboBox_MHAlgo1, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
            .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel_ParameterLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_ParameterLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jTextBox_mhMIN_Node, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel20)
                    .addComponent(jTextBox_mhMAX_Node, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel27, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel26)
                    .addComponent(jTextBox_mhMIN_Edge, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel25)
                    .addComponent(jTextBox_mhMAX_Edge, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel_ParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
        ...
        fntParamPanaleLayout.setVerticalGroup(
            fntParamPanaleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(fntParamPanaleLayout.createSequentialGroup()
                .addGroup(fntParamPanaleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, fntParamPanaleLayout.createSequentialGroup()
        ...
        jTabbedPaneDataselection.addTab("FNT modelling", jTabbedPaneTraining);
        ...
        jTextArea1.setText("V. K. Ojha, A. Abraham, V. Snášel\nEnsemble of heterogeneous flexible neural trees using multiobjective genetic programming,\nApplied Soft Computing, Volume 52, March 2017, Pages 909–924\nhttp://dx.doi.org/10.1016/j.asoc.2016.09.035\n\n\nV. K. Ojha, S. Schiano, C-Y. Wu, V. Snášel, A. Abraham, \nPredictive modeling of die filling of the pharmaceutical granules using the flexible neural tree\nNeural Comput & Applic (2016). \nhttp://link.springer.com/article/10.1007/s00521-016-2545-8\n\n\nAbdelwahab S., Ojha V.K., Abraham A. (2016) \nEnsemble of Flexible Neural Trees for Predicting Risk in Grid Computing Environment. \nIn: Snášel V., Abraham A., Krömer P., Pant M., Muda A. (eds) \nInnovations in Bio-Inspired Computing and Applications. \nAdvances in Intelligent Systems and Computing, vol 424. Springer, Cham\n\n\nWebsite: http://dap.vsb.cz/aat/\n\n\nEmail: vkojha@ieee.org\n\n");
    ...
    private FNT[][] readOldModel() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            oldFNTmodel = new FNT[Ot][m_Old_Ensemble_NumInt];
            //read FNT structures/models
            for (int j = 0; j < Ot; j++) {
                for (int k = 0; k < m_Old_Ensemble_NumInt; k++) {
                    oldFNTmodel[j][k] = new FNT(fntRNG);
...
//        String[] choices = {"fitting: traget and prediction", "regression plot"};
//        //Input dialog with a combo box
//        Object picked = JOptionPane.showInputDialog(this, "Pick a Plot:", "Select Plot Option", JOptionPane.QUESTION_MESSAGE, null, choices, choices[0]);
//        String plotType = "";
//        String PlotName = "";
//        if (picked != null) {
...
//        } else {
//            plotType = "regression";
//            PlotName = setName + " set: scatter plot";
//        }
//        for (int j = 0; j < outputColumns; j++) {
//            new EasyPtPlot(fileName, plotType, PlotName + " Output :" + (j + 1), points, j);
//        }
//        } else {
//            System.out.println("Plot Instruction Canceled");
//        }
//    }//plot output files
    private void plotOutputFiles(String setName, String fileName, int points, int outputColumns) {
        //Options for the combo box dialog
    ...
    public void saveCurrentModel() {
        ...
        try {
            ...
            String fileSuggetion = "FNT_" + (String) fntDataFileInfo.get(13);//taking dataset Name
    ...
    private void jComboBox_MHAlgo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_MHAlgo1ActionPerformed
        switch (jComboBox_MHAlgo1.getSelectedIndex()) {
            case 0: {
                ...
                //adding panels
                jPanel_ChooseAlgoEN.add(abcPanel1);
                jPanel_ChooseAlgoEN.repaint();
                jPanel_ChooseAlgoEN.revalidate();
                break;
            }
            case 1: {
                ...
                jPanel_ChooseAlgoEN.revalidate();
                //adding panels
                jPanel_ChooseAlgoEN.add(bfoPanel1);
                jPanel_ChooseAlgoEN.repaint();
                jPanel_ChooseAlgoEN.revalidate();
                break;
            }
            case 2: {
                ...
                jPanel_ChooseAlgoEN.revalidate();
                //adding panels
                jPanel_ChooseAlgoEN.add(dePanel1);
                jPanel_ChooseAlgoEN.repaint();
                jPanel_ChooseAlgoEN.revalidate();
                break;
            }
            case 3: {
                ...
                jPanel_ChooseAlgoEN.revalidate();
                //adding panels
                jPanel_ChooseAlgoEN.add(gwoPanel1);
                jPanel_ChooseAlgoEN.repaint();
                jPanel_ChooseAlgoEN.revalidate();
                break;
            }
            case 4: {
                ...
                jPanel_ChooseAlgoEN.revalidate();
                //adding panels
                jPanel_ChooseAlgoEN.add(psoPanel1);
                jPanel_ChooseAlgoEN.repaint();
                jPanel_ChooseAlgoEN.revalidate();
                break;
            }
    ...
    private void jComboBox_Ensemble_MethodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_Ensemble_MethodActionPerformed
        ...
        //        if (selectionEnAlgo.equalsIgnoreCase("Evolutionary_Weighted") || selectionEnAlgo.equalsIgnoreCase("Evolutionary_WMV")) {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.contains("#")) {
                        ...
                        switch (tokens[1]) {
                            ...
                            jTextBox_mhMIN_Node.setText(tokens[2]);
                            jTextBox_mhMAX_Node.setText(tokens[3]);
                            break;
                            case "MH_Algorithm_Edge_Range:":
                            jTextBox_mhMIN_Edge.setText(tokens[2]);
                            jTextBox_mhMAX_Edge.setText(tokens[3]);
                            break;
    ...
    private void jTextBox_mhMIN_EdgeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextBox_mhMIN_EdgeFocusLost
        try {
            Double.parseDouble(jTextBox_mhMIN_Edge.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Operation failed! " + e);
            System.out.print(e);
        }        // TODO add your handling code here:
    }//GEN-LAST:event_jTextBox_mhMIN_EdgeFocusLost

    private void jTextBox_mhMAX_EdgeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextBox_mhMAX_EdgeFocusLost
        try {
            Double.parseDouble(jTextBox_mhMAX_Edge.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Operation failed! " + e);
            System.out.print(e);
        }        // TODO add your handling code here:
    }//GEN-LAST:event_jTextBox_mhMAX_EdgeFocusLost
    ...
    private void jTextBox_mhMAX_NodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextBox_mhMAX_NodeFocusLost
        try {
            Double.parseDouble(jTextBox_mhMAX_Node.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Operation failed! " + e);
            System.out.print(e);
        }         // TODO add your handling code here:
    }//GEN-LAST:event_jTextBox_mhMAX_NodeFocusLost

    private void jTextBox_mhMIN_NodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextBox_mhMIN_NodeFocusLost
        try {
            Double.parseDouble(jTextBox_mhMIN_Node.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Operation failed! " + e);
            System.out.print(e);
        }         // TODO add your handling code here:
    }//GEN-LAST:event_jTextBox_mhMIN_NodeFocusLost
    ...
    private void jComboBox_Select_a_ProblemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_Select_a_ProblemActionPerformed
        ...
        switch (selectdProblem) {
            ...
            jComboBox_Select_a_Data_File.addItem("NNGC");
            jComboBox_Select_a_Data_File.addItem("Choose another file...");
            break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FNTFrame.class
    ...
    private javax.swing.JTextField jTextBox_mhMAX_Edge;
    private javax.swing.JTextField jTextBox_mhMAX_Node;
    private javax.swing.JTextField jTextBox_mhMIN_Edge;
    private javax.swing.JTextField jTextBox_mhMIN_Node;

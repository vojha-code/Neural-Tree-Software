...
public class TournamentSelection {
    ...
    FNT[] tournament_selection_SO(MersenneTwisterFast m_Random, FNT[] x, int pool_size, int tour_size) {
        rand = m_Random;
        int N = x.length;
    ...
    FNT[] tournament_selection(MersenneTwisterFast m_Random, FNT[] x, int pool_size, int tour_size) {
        rand = m_Random;
        int N = x.length;
        FNT[] matingPool = new FNT[pool_size];
        //Until the mating pool is filled, perform tournament selection
    ...
    FNT[] tournament_selection_SO(MersenneTwisterFast m_Random, FNT[] x, ArrayList gpParameters) {
        rand = m_Random;
        int N = x.length;

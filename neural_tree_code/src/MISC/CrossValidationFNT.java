 ...
 * @author Varun Ojha
 */
public class CrossValidationFNT {

    MersenneTwisterFast m_RNG;
    private FNT[][] bestGlobalTree;
    ...
    public void setCorssValidation(FNT[][] bestGlobalTree, MersenneTwisterFast random, ArrayList treeParams, ArrayList cvParameter, ArrayList mhParams, ArrayList algoParams) {
    ...
    public FNT[][] crossValidation(ArrayList dataFileInfo, int ensemble_Candidates, String m_Ensemble_Diversity) {
        ...
        for (int j = 0; j < Ot; j++) {
            for (int k = 0; k < ensemble_Candidates; k++) {
                sumTrain[j][k] = 0.0000000000001;
                sumTest[j][k] = 0.0000000000001;
            }//k models
        }//j outputs
    ...
    public ArrayList getError(ArrayList dataFileInfo, Pattern[] patTrain, Pattern[] patTest, PrintWriter fileTrain, PrintWriter fileTest, int ensemble_Candidates, String m_Ensemble_Diversity) {
        ...
        TrainingModuleFNT algorithm = new TrainingModuleFNT();
        for (int i = 0; i < Ot; i++) {//ith output
            FNT[] bestGlobalTreeLocal = algorithm.MHAlgorithmsReturn(m_RNG,bestGlobalTree[i], ev, i, treeParameters, mhParameters, aldoParameters, ensemble_Candidates, m_Ensemble_Diversity);
